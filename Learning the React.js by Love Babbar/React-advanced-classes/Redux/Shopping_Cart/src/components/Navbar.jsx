      ...
      <div className="flex flex-row justify-between items-center px-6 py-4">
        ...
        <div className="flex items-center space-x-6">
          ...
          <NavLink to="/cart" className="relative">
            ...
            {/* Cart Badge */}
            {/* <span className="absolute top-0 right-0 bg-red-500 text-white text-xs rounded-full h-4 w-4 flex items-center justify-center -translate-x-1/2 -translate-y-1/2">
